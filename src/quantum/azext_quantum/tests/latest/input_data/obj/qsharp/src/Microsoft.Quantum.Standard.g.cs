...
namespace Microsoft.Quantum.Arrays
{
    ...
    internal partial class _9fb28fce92e9471b89e50f0c575e4569_ForEach : Operation<(ICallable,IQArray<Qubit>), IQArray<Result>>, ICallable
    {
        public _9fb28fce92e9471b89e50f0c575e4569_ForEach(IOperationFactory m) : base(m)
        {
        }
        ...
        String ICallable.Name => "_9fb28fce92e9471b89e50f0c575e4569_ForEach";
        String ICallable.FullName => "Microsoft.Quantum.Arrays._9fb28fce92e9471b89e50f0c575e4569_ForEach";
...
#line 241 "/home/cloudtest/.nuget/packages/microsoft.quantum.standard/0.27.244707/lib/netstandard2.1/Microsoft.Quantum.Standard.dll"
        ...
        {
            return __m__.Run<_9fb28fce92e9471b89e50f0c575e4569_ForEach, (ICallable,IQArray<Qubit>), IQArray<Result>>((action, array));
        }
    }
}
...
namespace Microsoft.Quantum.Canon
{
    ...
    internal partial class _228adfe2fdff4a2b97877cb6396baf49_ApplyToEach : Operation<(ICallable,IQArray<Qubit>), QVoid>, ICallable
    {
        public _228adfe2fdff4a2b97877cb6396baf49_ApplyToEach(IOperationFactory m) : base(m)
        {
        }
        ...
        String ICallable.Name => "_228adfe2fdff4a2b97877cb6396baf49_ApplyToEach";
        String ICallable.FullName => "Microsoft.Quantum.Canon._228adfe2fdff4a2b97877cb6396baf49_ApplyToEach";
        private protected ICallable<IQArray<Qubit>, QRange> Microsoft__Quantum__Arrays___61c78f6bf53d48d6912ff28506356a70_IndexRange
        {
            get;
            set;
        }
...
#line 130 "/home/cloudtest/.nuget/packages/microsoft.quantum.standard/0.27.244707/lib/netstandard2.1/Microsoft.Quantum.Standard.dll"
            foreach (var idxQubit in Microsoft__Quantum__Arrays___61c78f6bf53d48d6912ff28506356a70_IndexRange.Apply(register))
#line hidden
            {
...
#line hidden
        ...
        public override void __Init__()
        {
            this.Microsoft__Quantum__Arrays___61c78f6bf53d48d6912ff28506356a70_IndexRange = this.__Factory__.Get<ICallable<IQArray<Qubit>, QRange>>(typeof(global::Microsoft.Quantum.Arrays._61c78f6bf53d48d6912ff28506356a70_IndexRange));
        }
        ...
        {
            return __m__.Run<_228adfe2fdff4a2b97877cb6396baf49_ApplyToEach, (ICallable,IQArray<Qubit>), QVoid>((singleElementOperation, register));
        }
    }
}
...
namespace Microsoft.Quantum.Measurement
{
    ...
    public partial class MultiM : Operation<IQArray<Qubit>, IQArray<Result>>, ICallable
    {
        ...
        private protected ICallable<(ICallable,IQArray<Qubit>), IQArray<Result>> Microsoft__Quantum__Arrays___9fb28fce92e9471b89e50f0c575e4569_ForEach
        {
            get;
            set;
        }
...
#line 75 "/home/cloudtest/.nuget/packages/microsoft.quantum.standard/0.27.244707/lib/netstandard2.1/Microsoft.Quantum.Standard.dll"
            return Microsoft__Quantum__Arrays___9fb28fce92e9471b89e50f0c575e4569_ForEach.Apply((Microsoft__Quantum__Intrinsic__M, targets));
        }

        ;
        public override void __Init__()
        {
            this.Microsoft__Quantum__Arrays___9fb28fce92e9471b89e50f0c575e4569_ForEach = this.__Factory__.Get<ICallable<(ICallable,IQArray<Qubit>), IQArray<Result>>>(typeof(global::Microsoft.Quantum.Arrays._9fb28fce92e9471b89e50f0c575e4569_ForEach));
